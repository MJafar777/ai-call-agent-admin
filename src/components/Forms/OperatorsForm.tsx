        ...
        <form className="bg-white/80  w-full flex justify-center rounded-2xl shadow-md">
            <div className="flex flex-col px-5 py-10 bg-zinc-200 justify-center gap-y-4 w-full rounded-lg p-4">
                ...
                <div className="flex flex-col ">
                    ...
                    <div className='flex justify-between border-1 px-3 bg-white border-zinc-300 py-1 rounded-md'>
                        <input type="text" placeholder="Email.." className=" focus:outline-none font-semibold" id="name" name="name" required />
                        <EmailIcon style={{color:"GrayText"}}/>
                    </div>
                </div>
                <div className="flex flex-col ">
                    <label htmlFor="name" className="font-bold text-zinc-600">Password</label>
                    <div className='flex justify-between border-1 px-3 bg-white border-zinc-300 py-1 rounded-md'>
                        <input type="text" placeholder="Password.." className=" focus:outline-none font-semibold" id="name" name="name" required />
                        <VpnKeyIcon style={{color:"GrayText"}}/>
                    </div>
                </div>
                <div className="flex flex-col ">
                    <label htmlFor="name" className="font-bold text-zinc-600">Co-password</label>
                    <div className='flex justify-between border-1 px-3 bg-white border-zinc-300 py-1 rounded-md'>
                        <input type="text" placeholder="Passwordni qayta kiriting.." className=" focus:outline-none font-semibold" id="name" name="name" required />
                        <VpnKeyIcon style={{color:"GrayText"}}/>
                    </div>
                </div>
